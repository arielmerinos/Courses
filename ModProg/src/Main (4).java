...
//
//
//                    for (int j = intValueOf(consulta.nextToken()); j < base.length; j |= j + 1)
//                        for (int k = intValueOf(consulta.nextToken()); k < base[0].length; k |= k + 1)
//                            base[j][k] += plaga;
//
//
//
...
>>>>>>> ef8a03a035b94f4fd3438e830dd9c72693e3c3be
